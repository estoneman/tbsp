...
maintaining some degree of accuracy. The edit distance scoring function goes to
0 as the edit distance goes to infinity. Therefore, my current implementation of
sliding windows computes the top k maximum scores per window. I am experimenting
with window sizes and values of k to find the optimal values to achieve my goal
